function [sys,x0,str,ts,simStateCompliance] = gamma_1_and_gamma_2(t,xsystem,uinput,flag,pa)
...
gamma_1 = k_x*dx_e*(sech((-k_x/l_x)*x_e))^2;
gamma_2 = k_y*dy_e*(sech((-k_y/l_y)*y_e))^2;
